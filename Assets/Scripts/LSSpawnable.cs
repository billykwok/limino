...
[Serializable]
public class LSSpawnable : ISerializationCallbackReceiver {
    public LSResizable resizable;
...
internal class LSSpawnableEditor : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        var labelProperty = property.FindPropertyRelative(nameof(LSSpawnable.classificationLabel));
        var editorClassificationIndex = property.FindPropertyRelative("_editorClassificationIndex");
        var prefab = property.FindPropertyRelative(nameof(LSSpawnable.resizable));
