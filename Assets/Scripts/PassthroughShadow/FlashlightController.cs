...
namespace PassthroughShadow {
    public class FlashlightController : MonoBehaviour {
        ...
        private void Start() {
            ...
            if (GetComponent<global::Flashlight>()) {
                GetComponent<global::Flashlight>().EnableFlashlight(false);
            }
        }
            ...
            if (!externalController) {
                ...
                if (!usingControllers) {
                    ...
                    if (OVRInput.GetUp(OVRInput.RawButton.A)) {
                        if (GetComponent<global::Flashlight>()) GetComponent<global::Flashlight>().ToggleFlashlight();
                    }
        ...
        public void Grab(OVRInput.Controller grabHand) {
            if (GetComponent<global::Flashlight>()) {
                GetComponent<global::Flashlight>().EnableFlashlight(true);
            }
