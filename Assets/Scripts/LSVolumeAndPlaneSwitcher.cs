...
public class LSVolumeAndPlaneSwitcher : MonoBehaviour {
    ...
    private void Start() {
        ...
        foreach (var pair in desiredSwitches) {
    ...
    private static void GetTopPlaneFromVolume(
        Transform volume,
        Vector3 dimensions,
        out Vector3 position,
        out Quaternion rotation,
        out Vector3 localScale) {
        var halfHeight = dimensions.y / 2.0f;
